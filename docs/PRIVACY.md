...
Sabeel ("the app") is a Qur'an reading and listening app built and published by **Aaqil Jamal**
(the "developer", "we") — an independent, one-person project, listed on Google Play as
_Sabeel (by Aaqil Jamal)_. This policy explains what the app does and does not do with your data.
...
sign-in, no analytics, no advertising, and no tracking. Everything you do in the app stays on
your device.

## What's stored on your device (only)
The app saves the following **locally on your device**, never transmitted to us:
- **Reading progress & recents** — the last verse/surah you were on, so you can continue.
- **Settings** — e.g. translation / transliteration / word-highlight toggles.
- **Downloaded audio** — surahs you choose to "save for offline" are stored in the app's
  private storage.

You can clear all of this at any time by clearing the app's storage or uninstalling the app.
...
## Children's privacy
The app is suitable for all ages and does not knowingly collect any information from anyone,
including children.
...
If this policy changes, we'll update the "Last updated" date above and publish the new version at
